...
class LeaderboardEvaluator(object):
    ...
    def __init__(self, args, statistics_manager):
        ...
        # print(f'scenario_class: {self._scenario_class}')
    ...
    def _cleanup(self):
        ...
        try:
            ...
            print(f'Error destroying actors')
        self.ego_vehicles = []
    ...
    def _load_and_run_scenario(self, args, config):
        ...
        print(f"\n\033[1m========= Preparing Town: {config.town}, route: {config.name},  "
              f"repetition: {config.repetition_index}) =========")
        # print("> Setting up the agent\033[0m")

        # Prepare the statistics of the route
        # print(f'name: {config.name}, index: {config.index}')
        ...
        print("\033[1m> Loading the world :{}".format(config.town))

        # Load the world and the scenario
        try:
            print(f'args.town: {args.town}, config_town :{config.town}')
        ...
        print(f"\033[1m> Running the route: {scenario.scenario.name}, {config.repetition_index}\033[0m")

        # print(f'type(scenario) :{type(scenario)}')
        # sys.exit(-1)
    ...
    def run(self, args):
        ...
        while route_indexer.peek():
            ...
            # print(f'config: {config.town}, {config.name}, {config.type}, {config.trajectory}')
